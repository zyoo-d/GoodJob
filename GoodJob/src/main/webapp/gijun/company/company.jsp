                    ...
                    <div class="table-responsive">
                      <table class="table table-striped">
                        <tr>
                          ...
                          <th class="p-0 text-center">스크랩수</th>
                          <th class="p-0 text-center">등록 일자</th>
                          <th class="p-0 text-center">업데이트 일자</th>
                        </tr>
                        <tr>
                          ...
                          <td class="p-0 text-center"><img src="/good/assets/img/logo/네이버.jpg" alt="네이버"></td>
                          <td class="p-0 text-center">
                            네이버
                          </td>
                          <td class="p-0 text-center">
                          ...
                          <td class="p-0 text-center">45000</td>
                          <td class="p-0 text-center">2017-01-01</td>
                          <td class="p-0 text-center">2024-03-04</td>
                        </tr>
                        <tr>
                          <td class="p-0 text-center">
                            <div class="custom-checkbox custom-control">
