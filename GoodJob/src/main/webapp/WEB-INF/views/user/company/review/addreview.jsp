...
.half-rated:before {
    content: "\f5c0"; /* FA icon code for half-star, change if needed */
}
.fas {
    color: gold; /* Example color for filled stars */
}

.far {
    color: #eee; /* Example color for empty stars */
}
    </style>
</head>
    ...
    <!-- Dynamically added tags will go here -->
        ...
        <hr>
                ...
                <div class="moving-btn">
                            ...
                            <a href="#" name="cp_rv_confirm" value="0" class="btn btnList submitRatings">등록하기</a>
                </div>
            </div>
        </div>   
    </section>
