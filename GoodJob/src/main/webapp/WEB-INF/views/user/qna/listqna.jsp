...
<section class="page-hero pt-16 pb-6">
		<div class="container">
          ...
          <div>
            <form id="searchForm" method="GET" action="/good/user/qna/listqna.do">
              <div class="InpBox">
              ...
              <input type="text" name="word" class="input" id="search-input" placeholder="검색어를 입력하세요">
          ...
          <div id="default_list_wrap" style="position:relative">
            <section class="list_recruiting">
                <div class="list-title">
                  <p><span class="material-symbols-outlined">subject</span></p><p>조회된 게시글은 총 <span id="list-cnt">${totalCount}</span>건입니다.</p>
                </div>
				...
				<div class="moving-btn">
                  ...
                  <div class="InpBox">
                    <select class="sorting" name="sort" id="sort">
					  ...
					  <option value="oldest" <c:if test="${param.sort == 'oldest'}">selected</c:if>>과거순</option>
					  <option value="comments" <c:if test="${param.sort == 'comments'}">selected</c:if>>댓글순</option>
                    </select>
                 </div>
              </div>
                    ...
                    <div class="com-title">
                      ...
                      <div class="col notification_info">
                        <div class="qnalist job_tit">
                          <a class="str_tit_title new" id="rec_link_48103333" onclick="" href="/good/user/qna/qnaview.do?qna_seq=${dto.qna_seq}" target="_blank" onmousedown=""><span>${dto.qna_title}</span></a>
                        </div>
                      </div>
                    </div>
                    <div class="com-info">
                      <div class="col recruit_info">
                        <ul>
                          ...
                          <li>
                            <p class="qna-add-date"><fmt:formatDate value="${dto.qna_regdate}" pattern="yyyy-MM-dd"/></p>
                          </li>
                          <li>
                            <p class="views-comments"><i class="fa-regular fa-eye"></i>${dto.qna_views}<i class="fa-regular fa-comment"></i>${dto.qna_comments}</p>
                          </li>
                        </ul>
                      </div>
                    </div>
