					...
					<div class="col-12">
						<div class="card" id="studyTable">
							<div class="card-header" id="studyHeader">
								<h4>${totalCount}개의 글을 작성하셨습니다.</h4>
								...
								<div class="table-responsive">
									<table class="table table-striped text-center">
										...
										<tr>
											...
											<td><div class="">
													<a href="/good/user/qna/editqna.do?qna_seq=${dto.qna_seq}">수정</a> / <a href="/good/user/qna/delqna.do?qna_seq=${dto.qna_seq}" class="text-danger">삭제</a>
												</div></td>
										</tr>
										</c:forEach>
									</table>
