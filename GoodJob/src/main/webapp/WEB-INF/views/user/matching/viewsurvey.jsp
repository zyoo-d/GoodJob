					...
					<div class="card-content-wrapper">
						<div class="px-4 text-center sizing">
							...
							<p class="survey-list mt-6">
								설문조사 결과를 토대로 ${name}님의 맞춤 기업을 추천해드립니다.<br> 성실하게 설문조사에 응하실
								경우 보다 정확한 정보가 제공됩니다.
							</p>

						</div>
						<form class="survey-form" id="surveyForm" method="post" action="/good/user/matching/addprefer.do">
							<!-- 질문시작 -->
								...
								<div class="survey section">
									...
									<div class="survey radio-toolbar">
										<input type="radio" id="${dto.sv_category}${dto.sv_seq}1"
											...
											for="${dto.sv_category}${dto.sv_seq}1">매우그렇다</label> <input
							...
							<button form="surveyForm" type="submit" class="btn btn-primary btn-survey-check">제출하기</button>
					</div>
				</div>
			</div>
		</section>
