...
<body>
	<section class="integration-single section pt-0">
		<div class="container">
			<div class="row justify-center">
				<c:if test="${wish=='0'}">
					<form method="post" action="/good/user/matching/addwish.do"
						id="wishForm">
				</c:if>
				<c:if test="${wish=='1'}">
					<form method="post" action="/good/user/matching/editwish.do"
						id="wishForm">
				</c:if>
					...
					<div
						...
						<div class="px-4 text-center">
							...
							<p class="mt-6">
								...
								선호사항을 자세히 알려주시면, 그에 맞춰 최적의 기업을 추천드리겠습니다.<br>(각 항목당 최소 1개
								선택이 필요합니다.)
							</p>
						</div>
						...
						<div class="mt-8 border-y border-border py-10" id="userDetail">
							...
							<div>
								...
								<input type="number" min="0" max="40" step="1"
									placeholder="숫자만 입력(0 ~)" id="career" name="career"
									value="${dto.career}" required>
							</div>
							<div>
								<h6 class="text-left preferTitle">
											...
											<td>
												<ul class="chk_list">
													...
													<li class="chk_item"><span class="inpChk small">
															...
															name="welfare" value="54" data-description="명절선물/귀향비"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp434">명절선물/귀향비</label>
													</span></li>
													<li class="chk_item"><span class="inpChk small">
															<input type="checkbox" id="welfare_cd_corp501"
															name="welfare" value="53" data-description="임신/출산 지원금"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp501">임신/출산 지원금</label>
													</span></li>
												</ul>
											</td>
											<td>
											...
											<td>
												<ul class="chk_list">
													...
													<li class="chk_item"><span class="inpChk small">
															...
															name="welfare" value="31" data-description="자회사 제품할인"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp484">자회사 제품할인</label>
													</span></li>
													<li class="chk_item"><span class="inpChk small">
															<input type="checkbox" id="welfare_cd_corp485"
															name="welfare" value="32" data-description="최신 장비"
															data-pass-onload-refresh="y"> <label class="lbl"
											...
											<td>
												<ul class="chk_list">
													<li class="chk_item"><span class="inpChk small">
															...
															name="welfare" value="60" data-description="수평적 조직문화"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp431">수평적 조직문화</label>
													</span></li>
													<li class="chk_item"><span class="inpChk small">
															<input type="checkbox" id="welfare_cd_corp432"
															name="welfare" value="55" data-description="회식강요 안함"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp432">회식강요 안함</label>
													</span></li>
													<li class="chk_item"><span class="inpChk small">
															<input type="checkbox" id="welfare_cd_corp433"
															name="welfare" value="56" data-description="야근강요 안함"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp433">야근강요 안함</label>
													</span></li>
													<li class="chk_item"><span class="inpChk small">
															<input type="checkbox" id="welfare_cd_corp466"
															name="welfare" value="57" data-description="자유복장"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp466">자유복장</label>
													</span></li>
													<li class="chk_item"><span class="inpChk small">
															<input type="checkbox" id="welfare_cd_corp467"
															name="welfare" value="58" data-description="캐주얼데이"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp467">캐주얼데이</label>
													</span></li>
													<li class="chk_item"><span class="inpChk small">
															<input type="checkbox" id="welfare_cd_corp514"
															name="welfare" value="59" data-description="자유로운 연차사용"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="welfare_cd_corp514">자유로운 연차사용</label>
													</span></li>
													<li class="chk_item"><span class="inpChk small">
															<input type="checkbox" id="welfare_cd_corp518"
															name="welfare" value="61" data-description="칼퇴근 보장"
															data-pass-onload-refresh="y"> <label class="lbl"
						...
						<div class="px-4 text-center">
							<c:if test="${wish=='0'}">
								<button id="btnAddWish" class="btn btn-primary w-full"
									type="submit">검사 결과 확인</button>
							</c:if>
							<c:if test="${wish=='1'}">
								<button id="btnEditWish" class="btn btn-primary w-full"
									type="submit">새로운 결과 확인</button>
							</c:if>
						</div>
					</div>
				</div>
	...
	<script>
		...
		$('#btnAddWish, #btnEditWish').on('click', function(event) {
