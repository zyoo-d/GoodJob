				...
				<section class="integration-single section pt-0">
					<div class="container">
						<div class="row justify-center">
							<c:if test="${wish=='0'}">
								<form method="post" action="/good/user/matching/addwish.do" id="wishForm">
							</c:if>
							<c:if test="${wish=='1'}">
								<form method="post" action="/good/user/matching/editwish.do" id="wishForm">
							</c:if>

							<div class="lg:col-10 mt-16">
								<div class="integration-single-container rounded-xl bg-white py-16 px-5 shadow-lg md:px-10 tab"
									...
									<div class="mt-8 border-y border-border py-10" id="userDetail">
										<div>
											...
											<select id="edu_seq" name="edu_seq">
										...
										<div>
											...
											<input type="number" min="0" max="40" step="1" placeholder="숫자만 입력(0 ~)"
												id="career" name="career" value="${dto.career}" required>
										</div>
										<div>
											<h6 class="text-left preferTitle">
									...
									<div class="border-b border-border py-10">
										...
										<div class="tag-group">
											<span id="lctag"> </span> <span class="clear" onclick="clearLocations()"><i
									...
									<div class="py-10">
										...
										<div class="table_scroll">
											<table class="default_table welfare_select_table" id="welfareCheckboxes">
												<colgroup>
															...
															<ul class="chk_list">
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp407"
																			name="welfare" value="44"
																			data-description="건강검진 지원"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp407">건강검진
																			지원</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp408"
																			name="welfare" value="45"
																			data-description="의료비지원"
																			data-pass-onload-refresh="y"> <label
																			class="lbl"
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp417"
																			name="welfare" value="46"
																			data-description="경조사 지원"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp417">경조사
																			지원</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp419"
																			name="welfare" value="51"
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp486"
																			name="welfare" value="47"
																			data-description="학자금 지원"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp486">학자금
																			지원</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp487"
																			name="welfare" value="48"
																			data-description="업무활동비 지원"
																			data-pass-onload-refresh="y"> <label
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp488"
																			name="welfare" value="52"
																			data-description="문화생활"
																			data-pass-onload-refresh="y"> <label
																			class="lbl"
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp495"
																			name="welfare" value="50"
																			data-description="복지카드/포인트"
																			data-pass-onload-refresh="y"> <label
																			class="lbl"
																			for="welfare_cd_corp495">복지카드/포인트</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp534"
																			...
																			data-description="결혼준비 지원"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp534">결혼준비
																			지원</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp434"
																			name="welfare" value="54"
																			data-description="명절선물/귀향비"
																			data-pass-onload-refresh="y"> <label
																			class="lbl"
																			for="welfare_cd_corp434">명절선물/귀향비</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp501"
																			name="welfare" value="53"
																			data-description="임신/출산 지원금"
																			data-pass-onload-refresh="y"> <label
															...
															<ul class="chk_list">
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp422"
																			name="welfare" value="10"
																			data-description="휴일(특근)수당"
																			data-pass-onload-refresh="y"> <label
																			class="lbl"
																			for="welfare_cd_corp422">휴일(특근)수당</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp423"
																			name="welfare" value="11"
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp499"
																			name="welfare" value="17"
																			data-description="4대 보험"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp499">4대
																			보험</label>
																	</span></li>
															</ul>
														</td>
															...
															<ul class="chk_list">
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp525"
																			name="welfare" value="38"
																			data-description="주 52시간"
																			data-pass-onload-refresh="y"> <label
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp527"
																			name="welfare" value="40"
																			data-description="주4.5일"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp527">주
																			4.5일</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp528"
																			name="welfare" value="39"
																			data-description="주4일"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp528">주
																			4일</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp529"
																			name="welfare" value="42"
																			data-description="사택 제공"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp529">사택
																			제공</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp530"
																			name="welfare" value="43"
																			data-description="주거비 지원"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp530">주거비
																			지원</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp535"
																			name="welfare" value="41"
															...
															<ul class="chk_list">
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp453"
																			name="welfare" value="21"
																			data-description="사내 카페"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp453">사내
																			카페</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp455"
																			name="welfare" value="22"
																			data-description="구내 식당"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp455">구내
																			식당</label>
																	</span></li>
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp457"
																			name="welfare" value="23"
																			data-description="정원"
																			data-pass-onload-refresh="y"> <label
																			class="lbl"
																...
																<li class="chk_item"><span class="inpChk small">
																		<input type="checkbox" id="welfare_cd_corp485"
																			name="welfare" value="32"
																			data-description="최신 장비"
																			data-pass-onload-refresh="y"> <label
																			class="lbl" for="welfare_cd_corp485">최신
																			장비</label>
																	</span></li>
															</ul>
														</td>
										...
										<div class="tag-group">
											<span id="weltag"> </span> <span class="clear" onclick="clearWelfares()"><i
									...
									<div class="px-4 text-center">
										<c:if test="${wish=='0'}">
											<button id="btnAddWish" class="btn btn-primary w-full"
												type="submit">제출하기</button>
										</c:if>
										<c:if test="${wish=='1'}">
											<button id="btnEditWish" class="btn btn-primary w-full"
				...
				<%@include file="/WEB-INF/views/inc/footer.jsp" %>
					<script>
						...
						$(document)
							.ready(
								function () {
									var wish = '${wish}';
									if (wish === '1') {
										var selectedSalarySeq = '${dto.salary_seq}';
										$('#salary_seq').val(selectedSalarySeq);

										var selectedEduSeq = '${dto.edu_seq}';
										$('#edu_seq').val(selectedEduSeq);

										var welSeqs = <c:out value='${dto.wel_seq}' default='[]' />;

										welSeqs
											.forEach(function (code) {
												var selector = '#welfareCheckboxes input[type="checkbox"][value="'
													+ code + '"]';
												var checkbox = $(selector);

												checkbox.prop('checked', true);
												var weltag = $('#weltag');
												var tagname = checkbox
													.data('description');
												var tagId = code;
												if ($("#" + tagId).length === 0) {
													weltag
						...
						function checkBoxes() {
							...
							if (lctag.children().length < 2 || weltag.children().length < 2) {
								alert('항목당 최소 1개 이상 선택해야합니다.');
								return false;   
							}
							return true;
						}
