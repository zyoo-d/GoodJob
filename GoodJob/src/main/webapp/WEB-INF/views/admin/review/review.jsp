														...
														<tr>
															...
															<td class="p-0 text-center status" data-toggle="modal"
																...
																style="cursor: pointer;"><c:if
																	test="${dto.cp_rv_confirm == 0}">대기
																			</c:if> <c:if test="${dto.cp_rv_confirm == 1}">승인
																			</c:if> <c:if test="${dto.cp_rv_confirm == 2}">거절
																			</c:if></td>
														</tr>
													</c:if>
												</c:forEach>
											...
											<ul class="pagination mb-0">
												<c:if test="${pageUtil.hasPreviousPage()}">
													<li class="page-item"><a class="page-link"
														href="/good/admin/review/review.do?page=${Math.max(pageUtil.startPage - 1, 1)}">
												...
												<c:forEach begin="${startPage}" end="${endPage}" var="page">
													<li
														...
														<a class="page-link"
														href="/good/admin/review/review.do?page=${page}">
															${page} </a>
													</li>
												</c:forEach>
												...
												<c:if test="${pageUtil.hasNextPage()}">
													<li class="page-item"><a class="page-link"
														href="/good/admin/review/review.do?page=${endPage + 1}">
