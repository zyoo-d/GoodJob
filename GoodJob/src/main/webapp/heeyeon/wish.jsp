...
<body>
		...
		<section class="section">
			<div id="search_panel_wrapper" class="recruit_search_panel">
									...
									<div class="layer_option">
										...
										<div class="area_check">
											<div class="inpChk small">
												<input type="checkbox" data-group="career" data-key="exp_cd"
													data-value="1" id="zero_experience"> <label
													for="zero_experience" class="lbl">신입</label>
											</div>
											<div class="inpChk small experience">
												<input type="checkbox" data-group="career" data-key="exp_cd"
													data-value="2" id="experience"> <label
													for="experience" class="lbl">경력</label>
											</div>
											<div class="inpChk small right">
												<input type="checkbox" data-group="career"
													data-key="exp_none" data-value="y" id="no_experience">
										...
										<div class="area_detail_select">
											...
											<ul class="btns" data-key="career">
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over0" data-index="0"
														name="check_career" title="~1년" value=""> <label
														for="btn_check_career_over0">~1년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over1" data-index="1"
														name="check_career" title="1년" value=""> <label
														for="btn_check_career_over1">1년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over2" data-index="2"
														name="check_career" title="2년" value=""> <label
														for="btn_check_career_over2">2년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over3" data-index="3"
														name="check_career" title="3년" value=""> <label
														for="btn_check_career_over3">3년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over4" data-index="4"
														name="check_career" title="4년" value=""> <label
														for="btn_check_career_over4">4년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over5" data-index="5"
														name="check_career" title="5년" value=""> <label
														for="btn_check_career_over5">5년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over6" data-index="6"
														name="check_career" title="6년" value=""> <label
														for="btn_check_career_over6">6년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over7" data-index="7"
														name="check_career" title="7년" value=""> <label
														for="btn_check_career_over7">7년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over8" data-index="8"
														name="check_career" title="8년" value=""> <label
														for="btn_check_career_over8">8년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over9" data-index="9"
														name="check_career" title="9년" value=""> <label
														for="btn_check_career_over9">9년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over10"
														data-index="10" name="check_career" title="10년" value="">
														<label for="btn_check_career_over10">10년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over11"
														data-index="11" name="check_career" title="11년" value="">
														<label for="btn_check_career_over11">11년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over12"
														data-index="12" name="check_career" title="12년" value="">
														<label for="btn_check_career_over12">12년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over13"
														data-index="13" name="check_career" title="13년" value="">
														<label for="btn_check_career_over13">13년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over14"
														data-index="14" name="check_career" title="14년" value="">
														<label for="btn_check_career_over14">14년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over15"
														data-index="15" name="check_career" title="15년" value="">
														<label for="btn_check_career_over15">15년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over16"
														data-index="16" name="check_career" title="16년" value="">
														<label for="btn_check_career_over16">16년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over17"
														data-index="17" name="check_career" title="17년" value="">
														<label for="btn_check_career_over17">17년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over18"
														data-index="18" name="check_career" title="18년" value="">
														<label for="btn_check_career_over18">18년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over19"
														data-index="19" name="check_career" title="19년" value="">
														<label for="btn_check_career_over19">19년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over20"
														data-index="20" name="check_career" title="20년" value="">
														<label for="btn_check_career_over20">20년</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_career_over21"
														data-index="21" name="check_career" title="20년~" value="">
                ...
                <li class="blank"></li>
										...
										<!-- dummy layer -->
										<div class="area_btn">
											<button type="button" data-clear="exp"
												class="btn_basic_type02 btn_reset">선택 초기화</button>
											<button type="button"
												class="closeDefaultOptionLayer btn_basic_type02 btn_close">닫기</button>
										</div>
										<!-- // -->
									</div>
								</div>
								<div class="search_option edu_option">
									...
									<div class="layer_option">
										...
										<div class="area_check">
											<div class="inpChk small right">
												<input type="checkbox" data-group="career"
													data-key="edu_none" data-value="y" id="no_education">
										...
										<div class="area_detail_select">
											...
											<ul class="btns" data-key="education">
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_edu_0" data-index="0"
														name="check_edu" title="고교 졸업 이하" value=""> <label
														for="btn_check_edu_0">고교 졸업<br>이하
													</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_edu_1" data-index="1"
														name="check_edu" title="고등학교 졸업" value=""> <label
														for="btn_check_edu_1">고등학교<br>졸업
													</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_edu_2" data-index="2"
														name="check_edu" title="대학 졸업 (2,3년제)" value=""> <label
														for="btn_check_edu_2">대학 졸업<br>(2,3년제)
													</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_edu_3" data-index="3"
														name="check_edu" title="대학교 졸업 (4년제)" value=""> <label
														for="btn_check_edu_3">대학교 졸업<br>(4년제)
													</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_edu_4" data-index="4"
														name="check_edu" title="대학원 석사 졸업" value=""> <label
														for="btn_check_edu_4">대학원 석사<br>졸업
													</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_edu_5" data-index="5"
														name="check_edu" title="대학원 박사 졸업" value=""> <label
														for="btn_check_edu_5">대학원 박사<br>졸업
													</label>
												</span></li>
												<li><span class="btn_check "> <input
														type="checkbox" id="btn_check_edu_6" data-index="6"
														name="check_edu" title="박사 졸업 이상" value=""> <label
														for="btn_check_edu_6">박사 졸업<br>이상
													</label>
												</span></li>
												<li class="blank"></li>
											</ul>
											<script id="education_template"
												type="text/x-handlebars-template">
                {{#list}}
                <li>
                    <span class="btn_check {{#optionsMarked mark}}mark{{/optionsMarked}}">
                ...
                <li class="blank"></li>
										...
										<!-- dummy layer -->
										<div class="area_btn">
											<button type="button" class="btn_basic_type02 btn_reset"
												data-clear="edu">선택 초기화</button>
											<button type="button"
												class="closeDefaultOptionLayer btn_basic_type02 btn_close">닫기</button>
										</div>
										<!-- // -->
								...
								<div class="search_option recently_search_option"
									id="mySearchListLayer" data-view="n">
									<button type="button" id="recently_search_btn"
										data-action="domestic" class="btn_open_layer track_event"
										data-track_event="my_search_management|click|loc|open"
										title="나의 검색 설정이 가능합니다.">
										...
										<div class="wrap_scroll_layer">
											<div class="layer_inner">
												<div class="wrap_title">
													<strong class="title">나의 검색 / 메일관리</strong>
													<div class="toolTipWrap">
														<button type="button" class="btn_help" title="도움말">도움말</button>
														<div class="toolTip"
															style="top: 30px; left: -80px; width: 238px">
															<span class="tail tail_top_left"></span>
															<div class="toolTipCont txtLeft">
																<strong class="toolTipTit">최대 20건 관리기능</strong>
																<p class="txt">
																	최근 나의 검색 최대 10건 자동 노출<br>저장된 나의 검색 최대 10건 노출
																</p>
															</div>
															<button type="button" class="btnClose"
																onclick="Saramin.favorTooltip(jQuery(this).closest('.toolTipWrap').find('.btn_help'), 'off');">
												...
												<div class="wrap_box_sort">
													<div class="inbox_sort">
														<span class="sort on" data-type="recently-search">
															<button type="button" class="track_event"
																data-track_event="my_search_management|click|loc|view_history">
																최근 나의 검색(<em>0</em>)
															</button>
														</span> <span class="sort" data-type="my-search">
															<button type="button" class="track_event"
																data-track_event="my_search_management|click|loc|view_saving">
																저장된 나의 검색(<em>0</em>)
															</button>
														</span> <span class="sort" data-type="all">
															<button type="button" class="track_event"
																data-track_event="my_search_management|click|loc|view_total">
																전체(<em>0</em>)
															</button>
														</span>
													</div>
													<div class="inbox_right">
														<span class="sort_txt"> <label
															for="search_list_title">저장 조건명</label>
														</span>
														<div class="box_edit">
															<input type="text" id="search_list_title" class="inpTypo"
																maxlength="15">
															<button type="button"
																class="btn_option btn_title_search track_event"
																data-track_event="my_search_management|click|loc|title_search">
																<span>검색</span>
															</button>
														</div>
														<div class="inpSel">
															<select title="" id="search_history_count"
																style="width: 96px" class="track_event"
																data-track_event="my_search_management|click|loc|list_change">
												...
												<div id="mySearchLHistory"></div>
											</div>
											<button type="button"
												class="closeDefaultOptionLayer btn_close">닫기</button>
										</div>
									</div>
								</div>
							</div>
										...
										<div class="select_keyword">
											<div class="wrap_auto_keyword">
												<span class="ipt_keyword"> <label
													for="area_ipt_keyword" class="blind">지역명 입력</label> <input
													type="text" name="loc" id="area_ipt_keyword"
													placeholder="지역명 입력" autocomplete="off">
												...
												<div class="wrap_result no_result"
													id="autocomplete_no_result">
            ...
            {{/list}}
											...
											<div class="wrap_scroll depth1" style="height: 245px;">
												<div class="scrollbar" style="height: 245px;">
													<div class="track" style="height: 245px;">
														<div class="thumb"
															style="top: 4.7025px; height: 115.211px;">
															<div class="end"></div>
														</div>
													</div>
												</div>
                        ...
                        {{/list}}
															...
															<li class="depth1_btn_wrapper " id="depth1_btn_220200"><button
																	type="button" class="depth1_btn_220200"
																	data-code="220200">
																	<span class="txt">미국 </span><span class="count">(120)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_211200"><button
																	type="button" class="depth1_btn_211200"
																	data-code="211200">
																	<span class="txt">일본 </span><span class="count">(130)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_211300"><button
																	type="button" class="depth1_btn_211300"
																	data-code="211300">
																	<span class="txt">중국·홍콩 </span><span class="count">(143)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_210000"><button
																	type="button" class="depth1_btn_210000"
																	data-code="210000">
																	<span class="txt">아시아·중동 </span><span class="count">(652)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_220000"><button
																	type="button" class="depth1_btn_220000"
																	data-code="220000">
																	<span class="txt">북·중미 </span><span class="count">(177)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_230000"><button
																	type="button" class="depth1_btn_230000"
																	data-code="230000">
																	<span class="txt">남미 </span><span class="count">(17)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_240000"><button
																	type="button" class="depth1_btn_240000"
																	data-code="240000">
																	<span class="txt">유럽 </span><span class="count">(100)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_250000"><button
																	type="button" class="depth1_btn_250000"
																	data-code="250000">
																	<span class="txt">오세아니아 </span><span class="count">(9)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_260000"><button
																	type="button" class="depth1_btn_260000"
																	data-code="260000">
																	<span class="txt">아프리카 </span><span class="count">(23)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_270000"><button
																	type="button" class="depth1_btn_270000"
																	data-code="270000">
																	<span class="txt">남극대륙 </span><span class="count">(0)</span>
																</button></li>
															<li class="depth1_btn_wrapper " id="depth1_btn_280000"><button
																	type="button" class="depth1_btn_280000"
																	data-code="280000">
																	<span class="txt">기타해외 </span><span class="count">(7)</span>
																</button></li>
                    ...
                    <ul class="list_check" id="sp_area_lastDepth_{{code}}">
                        ...
                        {{/list}}
															...
															<ul class="list_check" id="sp_area_lastDepth_101000">
																...
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101010"
																			name="loc_cd[]" value="101010"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101010" class="lbl"><span
																			class="txt">강남구</span><span class="count">
																				(19,675)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101020"
																			name="loc_cd[]" value="101020"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101020" class="lbl"><span
																			class="txt">강동구</span><span class="count">
																				(1,798)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101030"
																			name="loc_cd[]" value="101030"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101030" class="lbl"><span
																			class="txt">강북구</span><span class="count">
																				(577)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101040"
																			name="loc_cd[]" value="101040"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101040" class="lbl"><span
																			class="txt">강서구</span><span class="count">
																				(3,114)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101050"
																			name="loc_cd[]" value="101050"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101050" class="lbl"><span
																			class="txt">관악구</span><span class="count">
																				(1,825)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101060"
																			name="loc_cd[]" value="101060"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101060" class="lbl"><span
																			class="txt">광진구</span><span class="count">
																				(1,611)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101070"
																			name="loc_cd[]" value="101070"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101070" class="lbl"><span
																			class="txt">구로구</span><span class="count">
																				(3,374)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101080"
																			name="loc_cd[]" value="101080"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101080" class="lbl"><span
																			class="txt">금천구</span><span class="count">
																				(4,565)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101090"
																			name="loc_cd[]" value="101090"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101090" class="lbl"><span
																			class="txt">노원구</span><span class="count">
																				(661)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101100"
																			name="loc_cd[]" value="101100"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101100" class="lbl"><span
																			class="txt">도봉구</span><span class="count">
																				(331)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101110"
																			name="loc_cd[]" value="101110"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101110" class="lbl"><span
																			class="txt">동대문구</span><span class="count">
																				(1,152)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101120"
																			name="loc_cd[]" value="101120"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101120" class="lbl"><span
																			class="txt">동작구</span><span class="count">
																				(1,177)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101130"
																			name="loc_cd[]" value="101130"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101130" class="lbl"><span
																			class="txt">마포구</span><span class="count">
																				(4,249)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101140"
																			name="loc_cd[]" value="101140"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101140" class="lbl"><span
																			class="txt">서대문구</span><span class="count">
																				(1,025)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101150"
																			name="loc_cd[]" value="101150"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101150" class="lbl"><span
																			class="txt">서초구</span><span class="count">
																				(7,382)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101160"
																			name="loc_cd[]" value="101160"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101160" class="lbl"><span
																			class="txt">성동구</span><span class="count">
																				(3,505)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101170"
																			name="loc_cd[]" value="101170"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101170" class="lbl"><span
																			class="txt">성북구</span><span class="count">
																				(609)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101180"
																			name="loc_cd[]" value="101180"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101180" class="lbl"><span
																			class="txt">송파구</span><span class="count">
																				(5,312)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101190"
																			name="loc_cd[]" value="101190"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101190" class="lbl"><span
																			class="txt">양천구</span><span class="count">
																				(1,089)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101200"
																			name="loc_cd[]" value="101200"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101200" class="lbl"><span
																			class="txt">영등포구</span><span class="count">
																				(4,930)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101210"
																			name="loc_cd[]" value="101210"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101210" class="lbl"><span
																			class="txt">용산구</span><span class="count">
																				(2,081)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101220"
																			name="loc_cd[]" value="101220"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101220" class="lbl"><span
																			class="txt">은평구</span><span class="count">
																				(723)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101230"
																			name="loc_cd[]" value="101230"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101230" class="lbl"><span
																			class="txt">종로구</span><span class="count">
																				(2,046)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101240"
																			name="loc_cd[]" value="101240"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101240" class="lbl"><span
																			class="txt">중구</span><span class="count">
																				(3,532)</span></label>
																	</div>
																</li>
																<li>
																	<div class="inpChk">
																		<input type="checkbox" id="loc_cd_101250"
																			name="loc_cd[]" value="101250"
																			data-is_representative="n" data-representative=""
																			data-mcode="101000" data-check-type=""> <label
																			for="loc_cd_101250" class="lbl"><span
																			class="txt">중랑구</span><span class="count">
																				(610)</span></label>
																	</div>
																</li>
															</ul>
									...
									<div class="option_content job_category_section">
										...
										<div class="select_keyword">
											<div class="wrap_auto_keyword">
												<span class="ipt_keyword"> <label
													for="job_category_ipt_keyword" class="blind">직업(직무)
														또는 전문분야 입력</label> <input type="text" name="cat"
													id="job_category_ipt_keyword"
                            ...
                            {{/mclsList}}
																...
																<li class="item_job depth1_btn_wrapper"
																	...
																	<button type="button" data-mcls_cd_no="14"
																		...
																		<span class="txt">마케팅·홍보·조사 </span> <span
																			class="count">(11,174)</span>
																	</button>
																</li>
																<li class="item_job depth1_btn_wrapper"
																	id="depth1_btn_3">
																...
																<li class="item_job depth1_btn_wrapper"
																	...
																	<button type="button" data-mcls_cd_no="5"
																		...
																		<span class="txt">인사·노무·HRD </span> <span
																			class="count">(3,764)</span>
																	</button>
																</li>
																<li class="item_job depth1_btn_wrapper"
																	id="depth1_btn_4">
																...
																<li class="item_job depth1_btn_wrapper"
																	...
																	<button type="button" data-mcls_cd_no="9"
																		...
																		<span class="txt">연구·R&amp;D </span> <span
																			class="count">(7,622)</span>
																	</button>
																</li>
																<li class="item_job depth1_btn_wrapper"
																	id="depth1_btn_19">
																...
																<li class="item_job depth1_btn_wrapper"
																	...
																	<button type="button" data-mcls_cd_no="13"
																		...
																		<span class="txt">미디어·문화·스포츠 </span> <span
																			class="count">(6,050)</span>
																	</button>
																</li>
																<li class="item_job depth1_btn_wrapper"
																	id="depth1_btn_17">
									...
									<div class="option_content keyword_section">
										...
										<div class="layer_search_keyword no_suggest"
											...
											<div class="ipt_keyword">
												...
												<input type="text" name="" id="total_ipt_keyword"
    ...
    <li><button type="button" class="btn_keyword" data-value="{{keywordValue}}" data-type="auto" data-logging-flow="auto_keyword_search">{{keyword}}</button></li>
													...
													<div class="option_list">
														<div class="sri_select">
															...
															<ul id="sal_min_sel" class="list_opt">
																...
																<li><a href="#none" class="link_opt"
																	data-value="10" data-description="2,800만원 이상">2,800만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="11" data-description="3,000만원 이상">3,000만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="12" data-description="3,200만원 이상">3,200만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="13" data-description="3,400만원 이상">3,400만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="14" data-description="3,600만원 이상">3,600만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="15" data-description="3,800만원 이상">3,800만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="16" data-description="4,000만원 이상">4,000만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="17" data-description="5,000만원 이상">5,000만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="18" data-description="6,000만원 이상">6,000만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="19" data-description="7,000만원 이상">7,000만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="20" data-description="8,000만원 이상">8,000만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="21" data-description="9,000만원 이상">9,000만원
																		이상</a></li>
																<li><a href="#none" class="link_opt"
																	data-value="22" data-description="1억원 이상">1억원 이상</a></li>
															</ul>
														</div>
														<span class="inpChk small check_nocareer"> <input
															type="checkbox" id="sal_cd" name="sal_cd" value="0"
															data-description="회사내규에 따름 포함"
															data-pass-onload-refresh="y"> <label class="lbl"
															for="sal_cd">회사내규에 따름 포함</label>
														</span>
													</div>
												</div>
												<div id="sp_work_type"
													class="option_box job_form article_fold "
													style="display: block;">
														...
														<div class="sub_box">
															<ul>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="work_type" name="work_type"
																		value="1" data-value="1" data-description="재택근무 가능"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="work_type">재택근무 가능</label>
																</span></li>
															</ul>
														</div>
													</div>
        ...
        <ul id="sp_industry_3depth_{{bcode}}" class="depth3" data-bcode="{{bcode}}" style="display:none">
            ...
            {{/list}}
														...
														<div class="sub_box">
															<ul>
																...
																<li><span class="inpChk small"> <input
																		...
																		data-description="매출1000대기업"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="company_type_scale002">매출1000대기업</label>
																</span></li>
																<li><span class="inpChk small"> <input
														...
														<div class="sub_box">
															<ul>
																<li><span class="inpChk small"> <input
																		...
																		data-description="외국계(법인/투자)"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="company_type_foreign">외국계(법인/투자)</label>
																</span></li>
																<li><span class="inpChk small"> <input
																...
																<li><span class="inpChk small"> <input
																		...
																		data-description="학교·교육기관"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="company_type_school">학교·교육기관</label>
																</span></li>
																<li><span class="inpChk small"> <input
																...
																<li><span class="inpChk small"> <input
																		...
																		data-description="비영리단체,협회"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="company_type_nonprofit">비영리단체,협회</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="company_type_medical-institution"
																		name="company_type[]" value="medical-institution"
																		data-description="병원,의료기관"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="company_type_medical-institution">병원,의료기관</label>
																</span></li>
															</ul>
														</div>
														<div class="sub_box">
															<ul>
																<li><span class="inpChk small"> <input
																		...
																		name="company_type[]" value="kosdaq"
														...
														<div class="sub_box">
															<ul>
																...
																<li><span class="inpChk small"> <input
																		...
																		name="company_type[]"
																		value="corporate-juridical-person"
														...
														<div class="sub_box">
															<ul>
																<li><span class="inpChk small"> <input
																		...
																		data-description="병역특례 인증 업체"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="company_type_military">병역특례
																			인증 업체</label>
																</span></li>
																<li><span class="inpChk small"> <input
												...
												<div id="sp_job_type"
													...
													<div class="option_list">
														<div class="sub_box">
															<ul>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_1" name="job_type[]"
																		value="1" data-value="1" data-description="정규직"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_1">정규직</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_2" name="job_type[]"
																		value="2" data-value="2" data-description="계약직"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_2">계약직</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_5" name="job_type[]"
																		value="5" data-value="5" data-description="아르바이트"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_5">아르바이트</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_4" name="job_type[]"
																		value="4" data-value="4" data-description="인턴직"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_4">인턴직</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_9" name="job_type[]"
																		value="9" data-value="9" data-description="프리랜서"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_9">프리랜서</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_14" name="job_type[]"
																		value="14" data-value="14" data-description="파트"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_14">파트</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_8" name="job_type[]"
																		value="8" data-value="8" data-description="위촉직"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_8">위촉직</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_6" name="job_type[]"
																		value="6" data-value="6" data-description="파견직"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_6">파견직</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_15" name="job_type[]"
																		value="15" data-value="15" data-description="전임"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_15">전임</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_3" name="job_type[]"
																		value="3" data-value="3" data-description="병역특례"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_3">병역특례</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_12" name="job_type[]"
																		value="12" data-value="12" data-description="교육생"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_12">교육생</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="job_type_7" name="job_type[]"
																		value="7" data-value="7" data-description="해외취업"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="job_type_7">해외취업</label>
																</span></li>
															</ul>
														</div>
														<div class="set_open">
												...
												<div id="sp_work_day"
													class="option_box job_day article_fold">
														...
														<div class="sub_box">
															<ul>
																<li><span class="inpChk small"> <input
																		...
																		data-description="주 5일(월~금)"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="workday_wsh010">주 5일(월~금)</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="workday_wsh030" name="workday[]"
																		value="wsh030" data-value="wsh030"
																		data-description="주 6일(월~토)"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="workday_wsh030">주 6일(월~토)</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="workday_wsh040" name="workday[]"
																		value="wsh040" data-value="wsh040"
																		data-description="주 3일(격일제)"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="workday_wsh040">주 3일(격일제)</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="workday_wsh050" name="workday[]"
																		value="wsh050" data-value="wsh050"
																		data-description="유연근무제" data-pass-onload-refresh="y">
																		<label class="lbl" for="workday_wsh050">유연근무제</label>
																</span></li>
																<li><span class="inpChk small"> <input
																		type="checkbox" id="workday_wsh090" name="workday[]"
																		value="wsh090" data-value="wsh090"
																		data-description="면접 후 결정"
																		data-pass-onload-refresh="y"> <label
																		class="lbl" for="workday_wsh090">면접 후 결정</label>
																</span></li>
															</ul>
														</div>
														<div class="set_open">
												...
												<div id="sp_welfare">
													...
													<div id="sp_welfare_layer"
																		...
																		<td>
																			<ul class="chk_list">
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="건강검진"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp407">건강검진</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="금연수당"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp409">금연수당</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp417">각종
																							경조사 지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp419">단체
																							상해보험</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp441">헬스비
																							지급</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="본인학자금"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp486">본인학자금</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp487">업무활동비
																							지급</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp488"
																						name="welfare_cd[]" value="corp488"
																						data-description="문화생활비"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp488">문화생활비</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp489">통신비
																							지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp490">결혼준비
																							지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp491">해외여행
																							지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp496">난임 치료
																							지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp497">주요 제품
																							직원 할인</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp498"
																						name="welfare_cd[]" value="corp498"
																						data-description="자녀학자금"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp498">자녀학자금</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp534">사내
																							결혼식장 제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																		...
																		<td>
																			<ul class="chk_list">
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="퇴직연금"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp400">퇴직연금</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp401"
																						name="welfare_cd[]" value="corp401"
																						data-description="인센티브제"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp401">인센티브제</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp402"
																						name="welfare_cd[]" value="corp402"
																						data-description="상여금"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp402">상여금</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp403">장기근속자
																							포상</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="스톡옵션"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp405">스톡옵션</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp406"
																						name="welfare_cd[]" value="corp406"
																						data-description="퇴직금"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp406">퇴직금</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp420"
																						name="welfare_cd[]" value="corp420"
																						data-description="성과급"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp420">성과급</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp421"
																						name="welfare_cd[]" value="corp421"
																						data-description="야근수당"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp421">야근수당</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="연차수당"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp423">연차수당</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp424"
																						name="welfare_cd[]" value="corp424"
																						data-description="직책수당"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp424">직책수당</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp425"
																						name="welfare_cd[]" value="corp425"
																						data-description="자격증수당"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp425">자격증수당</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="위험수당"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp427">위험수당</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp428"
																						name="welfare_cd[]" value="corp428"
																						data-description="가족수당"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp428">가족수당</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp499"
																						name="welfare_cd[]" value="corp499"
																						data-description="4대 보험"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp499">4대 보험</label>
																				</span></li>
																			</ul>
																		</td>
																		<td>
																			<ul class="chk_list">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp437">크리스마스
																							선물</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp500">도서
																							무제한 제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp501">임신/출산
																							선물</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp502">웰컴키트
																							지급</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp503">생일자
																							조기퇴근</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp532">장기근속
																							선물</label>
																				</span></li>
																			</ul>
																		</td>
																		<td>
																			<ul class="chk_list">
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="창립일행사"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp100">창립일행사</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="워크샵"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp102">워크샵</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp103"
																						name="welfare_cd[]" value="corp103"
																						data-description="플레이샵"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp103">플레이샵</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp200">신규
																							입사자 교육(OJT)</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp202">리더십
																							강화교육</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="멘토링제도"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp206">멘토링제도</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp207">외국어
																							교육 지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp210">교육비
																							지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp211">자기계발비
																							지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp415">점심식사
																							제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp416">저녁식사
																							제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp418">사내동호회
																							운영</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp469">아침식사
																							제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp470"
																						name="welfare_cd[]" value="corp470"
																						data-description="간식 제공"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp470">간식 제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp471"
																						name="welfare_cd[]" value="corp471"
																						data-description="식비 지원"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp471">식비 지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp493">해외주재원
																							제도</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp504">해외
																							워크샵</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp506">취미
																							프로그램 운영</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp507">가족 초청
																							행사</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp531">신규입사자
																							멘토 제도</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp536">컨퍼런스
																							개최</label>
																				</span></li>
																			</ul>
																		</td>
																		<td>
																			<ul class="chk_list">
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="수유실"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp443">수유실</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp458">건물 내
																							경사로</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp459">휠체어용
																							난간</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp461">장애인
																							화장실</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="문턱 없음"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp465">문턱 없음</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp468"
																						name="welfare_cd[]" value="corp468"
																						data-description="유니폼지급"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp468">유니폼지급</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp481"
																						name="welfare_cd[]" value="corp481"
																						data-description="스마트기기"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp481">스마트기기</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp482"
																						name="welfare_cd[]" value="corp482"
																						data-description="노트북"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp482">노트북</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp483"
																						name="welfare_cd[]" value="corp483"
																						data-description="사원증"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp483">사원증</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp484">자회사
																							제품할인</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="사내도서관"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp508">사내도서관</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp509">사무용품
																							지급</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp512">사내
																							의원/약국</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp513">스탠딩
																							책상</label>
																				</span></li>
																			</ul>
																		</td>
																		...
																		<td>
																			<ul class="chk_list">
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp309">무제한
																							연차</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp431">수평적
																							조직문화</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp432">회식강요
																							안함</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp433">야근강요
																							안함</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp466"
																						name="welfare_cd[]" value="corp466"
																						data-description="자유복장"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp466">자유복장</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp467"
																						name="welfare_cd[]" value="corp467"
																						data-description="캐주얼데이"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp467">캐주얼데이</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp515">님/닉네임
																							문화</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp516"
																						name="welfare_cd[]" value="corp516"
																						data-description="출산 장려"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp516">출산 장려</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp518">칼퇴근
																							보장</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="문화 회식"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp520">문화 회식</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp533">사내연애
																							장려</label>
																				</span></li>
																			</ul>
																		</td>
																		<td>
																			<ul class="chk_list">
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp410">기숙사
																							운영</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp414">통근버스
																							운행</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp473"
																						name="welfare_cd[]" value="corp473"
																						data-description="사택제공"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp473">사택제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp474">사원아파트
																							임대</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp475">주택자금
																							융자</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="주차장제공"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp477">주차장제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp478"
																						name="welfare_cd[]" value="corp478"
																						data-description="주차비지원"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp478">주차비지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp479">회사차량
																							있음</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp480"
																						name="welfare_cd[]" value="corp480"
																						data-description="탄력근무제"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp480">탄력근무제</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp521">주거비
																							지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp522">전세자금
																							대출</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp523">출퇴근
																							교통비 지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp524"
																						name="welfare_cd[]" value="corp524"
																						data-description="재택근무"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp524">재택근무</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp525">주
																							52시간제 준수</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp526">주
																							40시간제 시행</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp527"
																						name="welfare_cd[]" value="corp527"
																						data-description="주4.5일"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp527">주4.5일</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp528"
																						name="welfare_cd[]" value="corp528"
																						data-description="주4일"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp528">주4일</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp535">자율
																							근무제</label>
																				</span></li>
																			</ul>
																		</td>
																		<td>
																			<ul class="chk_list">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="여름휴가"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp301">여름휴가</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp302"
																						name="welfare_cd[]" value="corp302"
																						data-description="경조휴가제"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp302">경조휴가제</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="창립일휴무"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp305">창립일휴무</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp306">근로자의
																							날 휴무</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp307"
																						name="welfare_cd[]" value="corp307"
																						data-description="휴가비지원"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp307">휴가비지원</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp308"
																						name="welfare_cd[]" value="corp308"
																						data-description="포상휴가"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp308">포상휴가</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp445">산전 후
																							휴가</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp446"
																						name="welfare_cd[]" value="corp446"
																						data-description="육아휴직"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp446">육아휴직</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																				...
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-description="보건휴가"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp448">보건휴가</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp456">휴양시설
																							제공</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						<input type="checkbox" id="welfare_cd_corp529"
																						name="welfare_cd[]" value="corp529"
																						data-description="패밀리데이"
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp529">패밀리데이</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp530">시간제
																							연차</label>
																				</span></li>
																				<li class="chk_item"><span class="inpChk small">
																						...
																						data-pass-onload-refresh="y"> <label
																						class="lbl" for="welfare_cd_corp310">공휴일
																							휴무</label>
																				</span></li>
																			</ul>
																		</td>
														...
														<div class="bottom_btn_wrap">
															<button type="button"
																class="btn_basic_type01 btn_register">선택완료</button>
														</div>
    ...
    <span id="{{id}}">{{name}}<button type="button" class="remove-btn">삭제</button></span>
							...
							<script id="sp_preview_selected_item_tmpl"
								type="text/x-handlebars-template">
