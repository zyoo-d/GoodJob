	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
			...
			if (n == 1) {
			    ...
			    sb.append(String.format(
			        "<li class='page-item z-custom'><a class='page-link' href='/good/board/interview/interview.do?page=%d&column=%s&word=%s&sort=%s'><span class='material-symbols-outlined paging-icon z-custom'>navigate_before</span></a></li>",
			        n - 1, column, word, sort));
			} else if (n > 5) {
			    sb.append(String.format(
			        "<li class='page-item z-custom'><a class='page-link' href='/good/board/interview/interview.do?page=%d&column=%s&word=%s&sort=%s'><span class='material-symbols-outlined paging-icon z-custom'>keyboard_double_arrow_left</span></a></li>",
			...
			while (!(loop > blockSize || n > totalPage)) {
			    if (n == nowPage) {
			        ...
			        sb.append(String.format(
			            "<li class='page-item z-custom'><a class='page-link' href='/good/board/interview/interview.do?page=%d&column=%s&word=%s&sort=%s'>%d</a></li>",
			...
			if (n >= totalPage) {
			    ...
			    sb.append(String.format(
			        "<li class='page-item z-custom'><a class='page-link' href='/good/board/interview/interview.do?page=%d&column=%s&word=%s&sort=%s'><span class='material-symbols-outlined paging-icon z-custom'>navigate_next</span></a></li>",
			        n, column, word, sort));
			    sb.append("<li class='page-item z-custom'><a class='page-link' href='#!'><span class='material-symbols-outlined paging-icon z-custom'>keyboard_double_arrow_right</span></a></li>");
			} else {
			    sb.append(String.format(
			        ...
			        n, column, word, sort));
			    sb.append(String.format(
			        "<li class='page-item z-custom'><a class='page-link' href='/good/board/interview/interview.do?page=%d&column=%s&word=%s&sort=%s'><span class='material-symbols-outlined paging-icon z-custom'>keyboard_double_arrow_right</span></a></li>",
			        n + 5, column, word, sort));
			}
