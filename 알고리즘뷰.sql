...
WHEN salary BETWEEN -1 AND -4 THEN 47000000
WHEN salary BETWEEN -6 AND -8 THEN 45000000
WHEN salary BETWEEN -10 AND -13 THEN 42000000
WHEN salary BETWEEN -14 AND -20 THEN 40000000
END
END AS max_sal
FROM (
SELECT
